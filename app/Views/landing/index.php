...
<head>
    ...
    <title>RS SIMRS — Sistem Informasi Manajemen Rumah Sakit</title>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background:#0d47a1">
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?= base_url('/') ?>"><i class="bi bi-hospital"></i> RS SIMRS</a>
        <div>
...
<div class="container py-4">
    <div class="hero p-5 mb-4 text-center">
        <h1 class="display-5 fw-bold">Sistem Informasi Manajemen Rumah Sakit</h1>
        <p class="lead mb-0">Pendaftaran • Antrian • Pemeriksaan • Laboratorium • Radiologi • Farmasi • Rawat Inap • Kasir • Laporan</p>
    ...
    <footer class="text-center text-muted py-4 mt-4 border-top">
        RS SIMRS &bull; Jl. Kesehatan No. 1, Jakarta &bull; Layanan booking online & rekam medis elektronik
    </footer>
</div>
</body>
</html>
